...
Comptes : Netlify Identity avec rôles `maitre` / `admin` / `en_attente` ; fonctions `netlify/functions/identity-signup.js` (inscription → en attente + e-mail au trésorier) et `comptes.js` (validation par le compte Maître).
